  ...
  return (
    <div className="bg-gray-100 p-6 rounded-md">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-gray-800">Sent Messages</h1>
        <p className="text-gray-600">View all your sent messages</p>
      </div>
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
        {
          messages.data?.length > 0 ? messages.data?.map((msg) => (
            <div key={msg.name} className="bg-white p-5 rounded-xl shadow-lg border cursor-pointer">
  
              <p className="text-sm text-gray-500 font-semibold mb-2">{msg.email}</p>
