        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              ...
              <Form action={createBlogs} className='flex flex-col gap-2'>

                <div>
                    <p className="text-sm/6 font-medium text-white">Name</p>
                    <input type='text' name='title' placeholder='Enter Project Title' className='mt-3 block w-full rounded-lg border-none bg-white/5 py-1.5 px-3 text-sm/6 text-white' />
                </div>
                ...
                <div>
                    ...
                    <input type='text' name='blogImages' placeholder='Enter Project Image Link' className='mt-3 block w-full rounded-lg border-none bg-white/5 py-1.5 px-3 text-sm/6 text-white' />
                </div>
